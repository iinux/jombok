...
@SupportedAnnotationTypes("com.iinux.jombok.Getter")
...
public class GetterProcessor extends AbstractProcessor {
    ...
    public synchronized void init(ProcessingEnvironment processingEnv) {
        ...
        try {
            ...
            messager.printMessage(Diagnostic.Kind.NOTE, "processingEnv className=" + processingEnv.getClass().getName());
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        try {
            Set<? extends Element> set = roundEnv.getElementsAnnotatedWith(com.iinux.jombok.Getter.class);
            set.forEach(element -> {
